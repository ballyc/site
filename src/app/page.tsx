export default function Home() {
  return (
    <main>
      ...
      <ul>
        <li><a href="#">Note title here</a> <span className="note-date">— May 1, 2026</span></li>
        <li><a href="#">Another note</a> <span className="note-date">— April 10, 2026</span></li>
        <li><a href="#">A third note</a> <span className="note-date">— March 3, 2026</span></li>
      </ul>
