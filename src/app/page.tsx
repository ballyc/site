export default function Home() {
  return (
    <main>
      ...
      <ul>
        <li><span className="proj">*engineer-review-pass*</span>: Custom Claude Code skill; sequenced, interactive engineering-manager review that dispatches a fresh sub-agent for an independent pass. Caught and fixed live bugs in its own prior version (the review run is the example output)<br></br>Runs on Claude Code (2026) [ <a href="https://github.com/ballyc/site/blob/main/src/app/engineer-review-pass/README.md" target="_blank">README.md</a>, <a href="https://github.com/ballyc/site/blob/main/src/app/engineer-review-pass/SKILL.md" target="_blank">skill.md</a>, <a href="https://github.com/ballyc/site/blob/main/src/app/engineer-review-pass/REVIEW.md" target="_blank">output example</a> ]</li>
        <li><span className="proj">*/company-brief*</span>: Custom Claude Code skill; automates the company research-to-briefing process. Reports saved in Obsidian, indexed and searchable. ROI 15x.<br></br>Runs on Claude Code (2026) [ <a href="https://github.com/ballyc/company-brief" target="_blank">repo</a>, <a href="https://github.com/ballyc/company-brief/blob/main/SKILL.md" target="_blank">skill.md</a>, <a href="https://github.com/ballyc/company-brief/blob/main/Example/Elevenlabs.md" target="_blank">output example</a> ]</li>
