export default function Home() {
  return (
    <main>
      ...
      <ul>
        <li><span className="proj">*engineer-review-pass*</span>: Custom skill; engineering-manager-style review of an implementation plan before writing code or skills — interactively walks through architecture, code quality, tests, performance and failure modes, surfacing each issue for you to decide.<br></br>Runs on Claude Code (2026) [ <a href="https://github.com/ballyc/site/blob/main/src/app/engineer-review-pass/README.md" target="_blank">README.md</a>, <a href="https://github.com/ballyc/site/blob/main/src/app/engineer-review-pass/SKILL.md" target="_blank">skill.md</a>, <a href="https://github.com/ballyc/site/blob/main/src/app/engineer-review-pass/REVIEW.md" target="_blank">output example</a> ]</li>
